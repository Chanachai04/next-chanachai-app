  ...
  return (
    <div className="border rounded-xl border-white/20 w-[400px]  px-7 py-4">
      <h1 className="text-4xl text-white py-2">
        <span className="text-[#FF5C00]">C</span>hanachai
      </h1>
      <Image src={"/me.jpg"} alt="Chanachai" width={700} height={500} className="rounded-2xl" priority />
      <div className="text-center">
        <p className="text-2xl text-white py-2">STU ID: 6652410007</p>
